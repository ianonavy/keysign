...
ALLOWED_EXTENSIONS = set(['gpg', 'zip', 'asc', 'sig'])
...
def upload_file():
    ...
    return render_template('index.html', fingerprints=get_fingerprints(),
        archive_sum=archive_sum, signed_archive_sum=signed_archive_sum)
